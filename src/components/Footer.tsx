        ...
        <div className="flex flex-col sm:flex-row gap-10 sm:justify-between items-start mb-6">
          ...
          <div className="flex flex-col self-start">
            <Link href="/" className="inline-flex items-center gap-2 hover:opacity-80 transition-opacity">
              ...
              <span className="text-white tracking-tight" style={{ fontFamily: '"Coinbase Display", system-ui, sans-serif', fontWeight: 500, fontSize: '36px', lineHeight: '36px' }}>defied</span>
            </Link>
