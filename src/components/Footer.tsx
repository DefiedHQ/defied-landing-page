...
export function Footer() {
  ...
  return (
    <footer className="w-full mt-auto" style={{ background: '#0A0B0D' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-10 sm:justify-between items-start mb-6">
          ...
          <div className="flex flex-col self-start">
            <Link href="/" className="inline-flex items-center gap-2 hover:opacity-80 transition-opacity">
              ...
              <span className="text-white tracking-tight" style={{ fontFamily: '"Coinbase Display", -apple-system, "system-ui", "Segoe UI", Roboto, Helvetica, Arial, sans-serif', fontWeight: 500, fontSize: '36px', lineHeight: '36px' }}>defied</span>
            </Link>
            ...
            <div className="flex items-center gap-3" style={{ marginTop: '16px' }}>
              <a href="https://x.com/defiedbg" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center hover:opacity-80 transition-opacity" style={{ background: '#1A1B1F', borderRadius: '8px' }}>
              ...
              <a href="https://linkedin.com/company/defiedbg" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center hover:opacity-80 transition-opacity" style={{ background: '#1A1B1F', borderRadius: '8px' }}>
              ...
              <a href="https://instagram.com/defiedbg" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center hover:opacity-80 transition-opacity" style={{ background: '#1A1B1F', borderRadius: '8px' }}>
