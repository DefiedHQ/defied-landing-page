          ...
          >
            <div className="hero-features-grid-4">
              {[
                ...
                <VStack key={feature.name} as="div" style={{ alignItems: 'center', textAlign: 'center', gap: '0px', minWidth: 0, width: '100%' }}>
                  <Box as="div" style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
