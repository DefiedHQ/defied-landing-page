  ...
  return (
    ...
    >
      ...
      <section id="what-it-does" className="section-padding" style={{ paddingTop: 'clamp(100px, 12vw, 160px)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
          <Text font="display2" as="h2" display="block" className="section-title section-title-right" style={{ fontSize: 'clamp(2rem, 4vw, 3.25rem)', fontWeight: 500, maxWidth: '600px', marginBottom: '56px' }}>
