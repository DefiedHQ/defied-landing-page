    ...
    >
      ...
      <section className="section-padding">
        ...
        >
          ...
          >
            <motion.div {...slideInLeft} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
              <Lottie source={dappWallet} autoplay loop width="300px" height="300px" />
            </motion.div>
            <motion.div {...slideInRight} style={{ display: 'flex', flexDirection: 'column', gap: '16px', flex: 1 }}>
      ...
      <section id="advantages" className="section-padding section-vertical-padding">
        <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
          ...
          <motion.div {...slideInRight} style={{ marginTop: '24px' }}>
            <div
              className="promo-card-layout"
              style={{
                background: '#0052FF',
          ...
          <motion.div {...slideInLeft} style={{ marginTop: '24px' }}>
            <div
              className="promo-card-layout"
              style={{
                background: 'rgb(247, 248, 249)',
      ...
      <section className="section-padding section-vertical-padding">
        ...
        >
          <motion.div {...slideInLeft} style={{ flex: 1 }}>
          ...
          <motion.div {...slideInRight} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
