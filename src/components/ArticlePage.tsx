        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-10 mb-16">
          ...
          <article className="min-w-0">
            ...
            <div className="space-y-8">
              {/* Lead paragraph */}
              <p style={{ fontSize: '20px', fontWeight: 550, lineHeight: '28px', marginBottom: '24px', fontStyle: 'italic', color: '#6b7280' }}>
                {article.excerpt}
              </p>
              ...
              {article.sections.map((section, i) => (
                <div key={i}>
                  <h2
                    id={`section-${i}`}
                    style={{ fontSize: '32px', fontWeight: 700, lineHeight: '100%', marginBottom: '24px', color: '#000' }}
                  >
                    {section.heading}
                  </h2>
                  <p style={{ fontSize: '20px', fontWeight: 550, lineHeight: '28px', color: '#6b7280' }}>
                    {section.body}
                  </p>
                </div>
              ))}
          ...
          <aside>
            ...
            <div style={{ marginBottom: '40px' }}>
              <h3 style={{ fontSize: '32px', fontWeight: 700, lineHeight: '100%', color: '#000', marginBottom: '24px' }}>
            ...
            <div style={{ marginBottom: '40px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {article.sections.map((section, i) => (
                <a
                  ...
                  className="block hover:text-[#1E1EE8] transition-colors"
                  style={{
                    fontSize: '20px',
                    fontWeight: 600,
                    color: '#374151',
            ...
            {/* Recent Posts */}
            <div>
              <h3 style={{ fontSize: '24px', fontWeight: 700, lineHeight: '100%', color: '#000', marginBottom: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                {recentArticles.map((a) => (
                  ...
                  >
                    ...
                    <h4
                      className="group-hover:text-[#1E1EE8] transition-colors"
                      style={{
                        fontSize: '24px',
                        fontWeight: 600,
                        color: '#000',
