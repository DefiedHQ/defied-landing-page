    ...
    <section style={{ width: '100%', maxWidth: '800px', margin: '0 auto', padding: '0 16px', paddingBottom: '64px' }}>
      ...
      <div style={sectionStyle}>
        ...
        <ul style={ulStyle}>
          ...
          <li style={liStyle}><span style={strongStyle}>Phishing attacks:</span> Malicious actors may attempt to impersonate Defied through fake websites, emails, or social media accounts in order to obtain your credentials. Always verify that you are accessing the Services through defied.money</li>
